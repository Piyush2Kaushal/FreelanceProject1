...
import imgImage2 from "../../assets/24105613f5e3ace9c1e90e196c6c96d49fe1bb05.webp";
import imgImage24 from "../../assets/3518a7f92431de5dbab98ccfd4d5e39239b555f0.webp";
import imgImage26 from "../../assets/ecbcb18116488299dd6fe702ece61e4a2566f4fc.webp";
import imgImage27 from "../../assets/7244749a076e598e9efe221712c15ad19b763081.webp";
import imgImage29 from "../../assets/0c6abfcbeaf31e67a46075117d8200149cb36cf4.webp";
import imgImage30 from "../../assets/22d465e475d321cbe6910a24e2a2b90cd914e608.webp";
import imgImage36 from "../../assets/c37db4459cf89aa602d24af4442a4287e514224e.webp";
import imgImage37 from "../../assets/1e97a161b5ff5bbfb58c23bf52d72fdfd17418e5.webp";
import imgImage38 from "../../assets/206d337464e0f7406b0f1b9670f6623191e801fe.webp";
import imgImage40 from "../../assets/87a5549b7ba9e4332abcdb934e8826ebd5735feb.webp";
import imgImage41 from "../../assets/051c45652caa1671f474e1cb4003f21c1089ce93.webp";
import imgImage42 from "../../assets/85e4ae52317a275bf2b084bce52dc9a4f49aa6c8.webp";
import imgImage43 from "../../assets/7304b74771a7b7a9cf8038df484ed9f255d3e65a.webp";
import imgImage44 from "../../assets/9123537afb8f13dfce31fc5e9065b0e4506a1a8f.webp";
import imgImage45 from "../../assets/446b4823c7d43d1f3cc14d8dd6bb50cf8e627248.webp";
import imgImage46 from "../../assets/4ebb7bddc973ce5b9272d6f2e92e71f624f1f3e5.webp";
import img14 from "../../assets/5e7b2cb2ed1103f45de90c50bbc4e48f5020ebde-Photoroom.png";
import imgImage169 from "../../assets/c1385cecd1feb9eea78bdd76ac8779e86985fc71.webp";
import imgImage171 from "../../assets/0e22e65ccdad8cd3108688fcf4d7d442bcda2c42-Photoroom.png";
import imgImage175 from "../../assets/4eb9769902805a1ea62ad96b3bc4f827b4aaa651.webp";
import imgImage182 from "../../assets/572dbe626303b4dc231b7ed9598a7ff410221ac8.webp";
import imgImage181 from "../../assets/b346545d66acf8454ca2d714cfd0ce7a845f80bd.webp";
import imgImage161 from "../../assets/Hello1.png";
import imgImage190 from "../../assets/04c63a8d0b8d326952426bc1876a936f5218d6fd-Photoroom.png";
...
function Frame() {
  return (
    <div
      ...
      data-name="Frame"
    >
  <div data-object="true" className="absolute flex h-[238.014px] items-center justify-center left-[758px] top-[810px] w-[271.09px]">
...
<div data-object="true" className="absolute flex h-[320.471px] items-center justify-center left-[980px] top-[960px] w-[250px]">
  <div className="flex-none rotate-[25.28deg]">
    <div className="h-[250px] relative w-[155px]" data-name="image 24">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div data-object="true" className="absolute flex h-[250px] items-center justify-center left-[1330px] top-[1080px] w-[260px]">
        <div className="flex-none rotate-[-18.69deg]">
          <div className="h-[190px] relative w-[200px]" data-name="image 27">
      ...
      <div data-object="true" className="absolute flex h-[162.795px] items-center justify-center left-[1420px] top-[590px] w-[182.721px]">
...
<div data-object="true" className="absolute h-[280px] left-[2977px] top-[689px] w-[208px]" data-name="image 30">
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <img loading="lazy" decoding="async" alt="" className="absolute h-[176.96%] left-[-28.79%] max-w-none top-0 w-[158.51%]" src={imgImage30} />
  </div>
</div>
<div data-object="true" className="absolute flex h-[158.895px] items-center justify-center left-[2060px] top-[640px] w-[148.735px]">
  <div className="flex-none rotate-[11.45deg]">
    <div className="h-[137px] relative w-[124px]" data-name="image 31">
      ...
      <div data-object="true" className="absolute h-[138px] left-[170px] top-[20px] w-[128px]" data-name="image 32">
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <img loading="lazy" decoding="async" alt="" className="absolute h-[139.15%] left-[-113.99%] max-w-none top-[-26.89%] w-[225.19%]" src={imgImage29} />
  </div>
</div>
<div data-object="true" className="absolute flex h-[181.757px] items-center justify-center left-[1950px] top-[1148px] w-[223.701px]">
  <div className="flex-none rotate-[13.02deg]">
    <div className="h-[141px] relative w-[197px]" data-name="image 36">
      ...
      <div data-object="true" className="absolute h-[190px] left-[20px] top-[121px] w-[90px]" data-name="image 37">
  <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage37} />
      ...
      <div data-object="true" className="absolute h-[161px] left-[970px] top-[580px] w-[107px]" data-name="image 38">
  <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage38} />
      ...
      <div data-object="true" className="absolute flex h-[268.844px] items-center justify-center left-[2100px] top-[820px] w-[197.714px]">
      ...
      <div data-object="true" className="absolute h-[170px] left-[1400px] top-[1385px] w-[150px]" data-name="image 42">
      ...
      <div data-object="true" className="absolute flex h-[268.856px] items-center justify-center left-[2200px] top-[1200px] w-[330.507px]">
      ...
      <div data-object="true" className="absolute flex h-[300px] items-center justify-center left-[1830px] top-[670px] w-[220px]">
  <div className="flex-none">
    <div className="h-[270px] relative w-[190px]" data-name="image 250">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img loading="lazy" decoding="async" alt="" className="absolute h-[150%] left-[-5%] max-w-none top-[-5%] w-[110%]" src={imgImage250} />
      </div>
    </div>
  </div>
</div>
      ...
      <div data-object="true" className="absolute flex h-[180.412px] items-center justify-center left-[1650px] top-[1150px] w-[228.902px]">
      ...
      <div data-object="true" className="absolute flex h-[252.433px] items-center justify-center left-[750px] top-[1250px] w-[404.202px]">
      ...
      <div data-object="true" className="absolute flex h-[210.75px] items-center justify-center left-[2545.36px] top-[1390.63px] w-[206.274px]">
      ...
      <div data-object="true" className="absolute h-[283px] left-[2000px] top-[1450px] w-[154px]" data-name="image 177">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div data-object="true" className="absolute h-[214px] left-[560px] top-[768px] w-[143px]" data-name="image 161">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[170.03%] left-0 max-w-none top-0 w-[195.71%]" src={imgImage161} />
        </div>
      </div>
      <div data-object="true" className="absolute h-[106px] left-[1203px] top-[900px] w-[157px]" data-name="image 184">
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <img loading="lazy" decoding="async" alt="" className="absolute h-[556.6%] left-[-190.18%] max-w-none top-[-0.17%] w-[290.45%]" src={imgImage161} />
      ...
      <div data-object="true" className="absolute h-[154px] left-[1550px] top-[900px] w-[104px]" data-name="image 187">
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
<div data-object="true" className="absolute h-[151px] left-[1200px] top-[680px] w-[220px]" data-name="image 185">
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <img loading="lazy" decoding="async" alt="" className="absolute h-[546.3%] left-[-190.18%] max-w-none top-[-97.09%] w-[290.45%]" src={imgImage161} />
      ...
      <div data-object="true" className="absolute h-[144px] left-[2300px] top-[1542px] w-[190px]" data-name="image 25">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
