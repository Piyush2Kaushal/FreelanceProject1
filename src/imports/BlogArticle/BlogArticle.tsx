...
import imgComponent20 from "../../assets/4e454c35d52b905142f0f45a93315e3a6c51ea01.webp";
...
/>
      ...
      >
        <svg width="22" height="22" viewBox="0 0 20 20" fill="none">
          <line x1="3" y1="3" x2="17" y2="17" stroke="#DCD1B1" strokeWidth="1.6" strokeLinecap="round" />
          <line x1="17" y1="3" x2="3" y2="17" stroke="#DCD1B1" strokeWidth="1.6" strokeLinecap="round" />
        </svg>
      </button>
        ...
        {navLinks.map((item, index) => (
          <a
            ...
            style={{
              ...
              padding: "14px 0",
              borderBottom: index < navLinks.length - 1 ? "1px solid #DCD1B1" : "none",
              opacity: isOpen ? 1 : 0,
    ...
    <>
      <div className="sticky top-0 left-0 right-0 z-[100] w-full flex items-center justify-between px-5 py-4" style={{ background: "rgba(95,50,35,0.92)", backdropFilter: "blur(8px)", borderBottom: "1px solid rgba(220,209,177,0.12)" }}>
        ...
        <button
          ...
          style={{ width: 36, height: 36, borderRadius: "50%", background: "rgba(218,208,173,0.12)", border: "1.5px solid rgba(218,208,173,0.3)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
        >
